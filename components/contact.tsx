  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12 sm:py-16">
      ...
      <p className="mt-2 text-neutral-300">
        Interested in collaborating or hiring? Feel free to reach out — I’ll
        reply within 1–2 business days. You can also ping me in discord:
        @martico2432
      </p>
      <p className="mt-2 text-neutral-300">
        Curently disabled, please, send an email directly to
        marticodev@gmail.com
      </p>

      <form
        ref={formRef}
        className="mt-6 grid gap-4 rounded-lg border border-neutral-800/60 bg-neutral-900/40 p-5 backdrop-blur"
      >
